			...
			public void actionPerformed(ActionEvent e) {
				if (controller instanceof UserMediaPageController) {
					if(singlePane.getData() instanceof PhysicalMedia) {
						...
						((UserMediaPageController) controller).addToCart(singlePane.getData().getId(), singlePane.getData().getTitle(), singlePane.getData().getCost(), (int)spin.getValue(), physicalMedia.getWeight());
					}
				}
			}
		});
